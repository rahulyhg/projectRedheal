...
public class EducationAdapter1 extends ArrayAdapter<EducationItem> {
    ...
    public EducationAdapter1(Context context, int resource, List<EducationItem> books) {
    ...
    @Override
    public EducationItem getItem(int pos) {
        ...
        holder.overflow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               /* Toast.makeText(getContext(), "delete"+position, Toast.LENGTH_SHORT).show();
                getContext().startActivity(new Intent(getContext(),EducationEditActivity.class));*/
