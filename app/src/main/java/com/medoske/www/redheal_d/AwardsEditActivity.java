...
public class AwardsEditActivity extends AppCompatActivity {
    List<NameValuePair> param = new ArrayList<>();
    JSONParser jsonParser = new JSONParser();
    ArrayList<AwardItem> awardItems = new ArrayList<AwardItem>();
    AwardsAdapter awardsArrayAdapter;
    private static String URL_AWARDS;
    String doctorId,doctorName,awards;
    ListView awardsList;
    EditText etAwards;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_awards_edit);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("Edit Awards & recognition");
        ...
        //------------------ awards url
        URL_AWARDS= Apis.DOCTORS_RECOGNIZATION_URL+doctorId;
        Log.e("awards_url",""+URL_AWARDS);

        etAwards=(EditText)findViewById(R.id.etAwards);
    ...
    private void checkValidation() {
        ...
        awards = etAwards.getText().toString().trim();

        // Check for both field is empty or not
        if (awards.equals("") ) {
            // loginLayout.startAnimation(shakeAnimation);
            Toast.makeText(AwardsEditActivity.this, "Enter All Fields", Toast.LENGTH_LONG).show();

        }else if (awards.isEmpty() || awards.length()<3){
            etAwards.setError("Enter Minimum 3 Characters");
            return;
        }

        else{
            new AwardsAsyncclass().execute();
        }
    ...
    public class AwardsListData extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(AwardsEditActivity.this);
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                ...
                JSONArray jsonArray = json.optJSONArray("doctor_awards");
            ...
            {
                awardsArrayAdapter = new AwardsAdapter(AwardsEditActivity.this, R.layout.profile_list_item, awardItems);
                //list= (ListView) findViewById(R.id.listView);
                awardsList.setItemsCanFocus(false);
                awardsList.setAdapter(awardsArrayAdapter);
                ProfileActivity.ListUtils.setDynamicHeight(awardsList);
            }
            else
            {
...
//                myAppAdapter.notifyDataSetChanged();
    ...
    public String Awards_POST(String[] params, AddProfileFragmentItem addServiceItem){
        InputStream inputStream = null;
        String result = "";
        HttpResponse response = null;
        try {
            HttpClient httpclient = new DefaultHttpClient();
            HttpPost httppost = new HttpPost(Apis.ADD_RECOGNIZATION_URL);

            try {

                MultipartEntity entity = new MultipartEntity();
                entity.addPart("awards_recognization", new StringBody(addServiceItem.getService()));
                Log.e("awards_recognization===",""+addServiceItem.getService());
    ...
    private class AwardsAsyncclass extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(AwardsEditActivity.this);
        ...
        protected void onPostExecute(String jsonObject) {
            ...
            Intent in = new Intent(AwardsEditActivity.this, AwardsEditActivity.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
       // startActivity(new Intent(AwardsEditActivity.this,ProfileActivity.class));
    }
