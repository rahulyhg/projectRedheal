...
import com.medoske.www.redheal_d.MembershipEditActivity;
 ...
 */
public class MembershipAdapter extends ArrayAdapter<MembershipItem> {
    ...
    public MembershipAdapter(Context context, int resource, List<MembershipItem> books) {
    ...
    @Override
    public MembershipItem getItem(int pos) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        holder.overflow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String deleteId =  getItem(position).getMembershipId();
                ...
                /*remove(serviceItem);
                notifyDataSetChanged();*/
               // getContext().startActivity(new Intent(getContext(),MembershipEditActivity.class));
    ...
    class DoUpdateProfile extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                URL url = new URL(Apis.DOCTORS_MEMBERSHIP_URL);
    ...
    class DoDeleteProfile extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                URL url = new URL(Apis.DOCTORS_MEMBERSHIP_URL+id);
                Log.e("deleteurl",""+url);
